...
export function HeroSection({
  headline = "Beauty That Enhances Your Natural Glow",
  subheadline = "Personalized skincare, makeup artistry, and beauty treatments crafted by Sarit Elkayam — because you deserve to look and feel extraordinary.",
  ...
  return (
    ...
    >
      ...
      <Container>
        <div className="relative grid lg:grid-cols-2 gap-8 md:gap-12 items-center py-8 md:py-24 lg:py-32">
          {/* Text content */}
          ...
          >
            <div className="relative">
              ...
              <ImagePlaceholder
                width="w-60 h-80 md:w-80 md:h-[28rem]"
                className="relative rounded-3xl shadow-soft-lg"
              />
            </div>
          </motion.div>
        </div>
