           ...
           <div className="pt-4 border-t border-cream-200">
             ...
             <Card className="p-6 bg-cream-50">
               <div className="flex items-center justify-between mb-3">
                 ...
                 <span className="font-body font-medium text-rose-400">{price}</span>
               </div>
               ...
               {featuresHe && (
                 <ul className="space-y-1">
                   {featuresHe.split('\n').filter(line => line.trim()).slice(0, 3).map((feature, i) => (
                     <li key={i} className="flex items-center gap-2 font-body text-sm text-charcoal-500">
