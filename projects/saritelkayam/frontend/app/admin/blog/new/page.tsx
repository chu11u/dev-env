  ...
  return (
     <div>
       <div className="mb-8">
         ...
         <h1 className="font-heading text-3xl font-bold text-charcoal-800 mb-2">New Blog Post</h1>
         <p className="font-body text-charcoal-500">Create a new blog post for your beauty blog.</p>
       </div>
       ...
       <form onSubmit={handleSubmit}>
         <Card className="p-6 md:p-8 space-y-6 max-w-4xl">
           ...
           <Input
             ...
             required
           />
           <p className="font-body text-xs text-charcoal-400">URL: /blog/{slug || 'your-slug-here'}</p>
