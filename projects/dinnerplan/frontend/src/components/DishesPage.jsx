        ...
        <div className="container">
          ...
          >
            <div>
              <h1>🥘 מנות</h1>
              {dinnerId && (
                <p>ניהול מנות לארוחה: {getDinnerName(dinnerId)}</p>
               )}
              {!dinnerId && <p>מאגר המנות - בחר מנה קיימת לארוחה או צור מנה חדשה</p>}
              {dinnerId && (
                <Link
                  to="/dinner/${dinnerId}"
                        ...
                        {assignedDinners.length \u003e 0 \u0026\u0026 (
                          <div style={{ marginTop: 8 }}>
                            {assignedDinners.map((dd) => (
                              ...
                              >
                                🍽️ {getDinnerName(dd.dinnerId)} — {getFamilyName(dd.familyId)}
                                <button
                    ...
                    {availableDishesForDinner.map((dish) => (
                      ...
                      >
                        ...
                        <select
                          ...
                          style={{ marginTop: 8, width: "100%", padding: "8px 12px", border: "2px solid var(--color-border)", borderRadius: 12 }}
                          id={`family-${dish.id}`}
                        >
                        ...
                        <button
                          ...
                          onClick={() => {
                            const selectEl = document.getElementById(`family-${dish.id}`);
