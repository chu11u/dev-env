...
export const api = {
  ...
  createFamily: (family) => request('/families', { method: 'POST', body: family }),
  updateFamily: (id, family) => request(`/families/${id}`, { method: 'PUT', body: family }),
  deleteFamily: (id) => request(`/families/${id}`, { method: 'DELETE' }),

  // Dinners
  getDinners: () => request('/dinners'),
  createDinner: (dinner) => request('/dinners', { method: 'POST', body: dinner }),
  updateDinner: (id, dinner) => request(`/dinners/${id}`, { method: 'PUT', body: dinner }),
  ...
  createShoppingItem: (item) => request('/shopping', { method: 'POST', body: item }),
  updateShoppingItem: (id, item) => request(`/shopping/${id}`, { method: 'PUT', body: item }),
